...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.6757f8cb1c59590367618cbdc0f4da755ce373a3648447e4d9d888e20b5196a0.js',function(){input.required=false;search();});}
